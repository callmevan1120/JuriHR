  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description={`Mode ${mode} — ${mode === "bulanan" ? monthLabel(format(anchorDate, "yyyy-MM")) : `${formatDateMed(range.from)} — ${formatDateMed(range.to)}`}`}
        actions={
          <>
        ...
        <CardContent className="flex flex-col gap-3 py-3 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-1 flex-wrap items-center gap-2 lg:justify-end">
            ...
            <Select value={filterOutlet} onValueChange={setFilterOutlet}>
              <SelectTrigger className="h-8 w-[130px] text-xs"><SelectValue placeholder="Outlet" /></SelectTrigger>
              <SelectContent>
            ...
            <Select value={filterDivision} onValueChange={setFilterDivision}>
              <SelectTrigger className="h-8 w-[130px] text-xs"><SelectValue placeholder="Divisi" /></SelectTrigger>
              <SelectContent>
            ...
            <Select value={filterShiftGroup} onValueChange={setFilterShiftGroup}>
              <SelectTrigger className="h-8 w-[150px] text-xs"><SelectValue placeholder="Shift Group" /></SelectTrigger>
              <SelectContent>
            ...
            <Badge variant="outline" className="text-xs">
              <Users className="size-3" /> {filteredEmps.length} karyawan
            </Badge>
          </div>
        </CardContent>
      </Card>
