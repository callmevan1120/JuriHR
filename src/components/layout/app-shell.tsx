    ...
    <SidebarProvider>
      ...
      <SidebarInset className="min-w-0 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex flex-1 flex-col min-w-0 overflow-y-auto overflow-x-hidden">
          <main className="mx-auto w-full max-w-[1440px] flex-1 px-3 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-5 min-w-0">
            <div className="animate-fade-in min-w-0">
              <RouteView />
            </div>
          </main>
          <footer className="hidden sm:block mt-auto border-t border-border/50 bg-card/50 px-4 py-3 sm:px-6">
